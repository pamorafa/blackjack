...
static constexpr auto qt_meta_stringdata_ZN4mesaE = QtMocHelpers::stringData(
    "mesa",
...
Q_CONSTINIT static const uint qt_meta_data_ZN4mesaE[] = {
...
Q_CONSTINIT const QMetaObject mesa::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN4mesaE.offsetsAndSizes,
    qt_meta_data_ZN4mesaE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN4mesaE_t,
        // Q_OBJECT / Q_GADGET
...
void *mesa::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN4mesaE.stringdata0))
